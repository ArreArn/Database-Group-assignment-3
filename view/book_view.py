...
class BookTab(QWidget):
    ...
    def add_book(self) -> None:
        ...
        try:
            ...
            publisher_id=int(publisher) if publisher.isdigit() else None
    ...
    def update_book(self) -> None:
        ...
        if year:
            book_year = year
        ###YOUR CODE###
        book_publisher_id=int(publisher) if publisher and publisher.isdigit() else int(book_publisher_id)
        try:
